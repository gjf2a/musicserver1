...
impl PendingNote {
    ...
    pub fn instant_rest_from(&self) -> Note {
        Note {pitch: self.pitch as MidiByte, duration: OrderedFloat(0.0), intensity: OrderedFloat(0.0)}
    }
}
...
mod tests {
    ...
    fn test_synchro() {
        ...
        for (n, d, i) in [
            (57, 0.00, 0.55), (65, 0.01, 0.80), (60, 0.00, 0.72), (64, 0.00, 0.83),
            (62, 0.15, 0.80), (64, 0.06, 0.00), (57, 0.01, 0.00), (60, 0.03, 0.00),
            (62, 0.00, 0.00), (65, 0.08, 0.00)
        ] {
            m.add(Note {pitch: n, duration: OrderedFloat(d), intensity: OrderedFloat(i)});
        }
